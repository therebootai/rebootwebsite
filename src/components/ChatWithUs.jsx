    ...
    >
      <div className={` flex flex-col gap-4  ${isAnimated ? "animate" : ""}`}>
        <Link
          ...
          target="_blank"
          rel="noopener"
          className="bg-[#00C16A] text-2xl lg:text-2xl  border border-white gap-2  text-white rounded-full justify-center items-center flex px-4 md:px-5 lg:px-6 h-[3rem] md:h-[3.5rem] lg:h-[3.5rem] cursor-pointer"
        >
